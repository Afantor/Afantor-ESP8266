 ...
 */
DigitalDisplay::DigitalDisplay(uint8_t dataPin, uint8_t clkPin)
{
  _dataPin = dataPin;
  _clkPin = clkPin;
 ...
 */
void DigitalDisplay::setpin(uint8_t dataPin, uint8_t clkPin)
{
  _dataPin = dataPin;
  _clkPin = clkPin;
  pinMode(_clkPin, OUTPUT);
 ...
 * \par Others
 */
void DigitalDisplay::clearDisplay(void)
{
  uint8_t buf[4] = { ' ', ' ', ' ', ' ' };
  display(buf);
}
 ...
 *    None
 */
void DigitalDisplay::writeByte(uint8_t wr_data)
{
  uint8_t i;
  uint8_t cnt0;
 ...
 *    None
 */
void DigitalDisplay::start(void)
{
 ...
 *    None
 */
void DigitalDisplay::write(uint8_t SegData[])
{
  uint8_t i;
 ...
 *    None
 */
void DigitalDisplay::write(uint8_t BitAddr, uint8_t SegData)
{
  start();    // start signal sent to TM1637 from MCU
 ...
 *    None
 */
void DigitalDisplay::display(uint16_t value)
{
 ...
 *    None
 */
void DigitalDisplay::display(int16_t value)
{
 ...
 *    None
 */
void DigitalDisplay::display(float value)
{
  uint8_t i=0;
  bool isStart = false;
  uint8_t index = 0;
 ...
 *    None
 */
void DigitalDisplay::display(long value)
{
  display((double)value, 0);
}
 ...
 *    None
 */
int16_t DigitalDisplay::checkNum(float v,int16_t b)
{
  if(b>=0)
  {
 ...
 *    None
 */
void DigitalDisplay::display(double value, uint8_t digits)
{
Posotion_1:
  uint8_t buf[4] = { ' ', ' ', ' ', ' ' };
  uint8_t tempBuf[4];
 ...
 *    None
 */
void DigitalDisplay::display(uint8_t DispData[])
{
  uint8_t SegData[4];
  uint8_t i;
  for (i = 0; i < 4; i++)
 ...
 *    None
 */
void DigitalDisplay::display(uint8_t BitAddr, uint8_t DispData)
{
  uint8_t SegData;
 ...
 *    None
 */
void DigitalDisplay::display(uint8_t BitAddr, uint8_t DispData, uint8_t point_on)
{
  uint8_t SegData;
 ...
 * \param[in]
 *    brightness - Brightness, defined in DigitalDisplay.h from BRIGHTNESS_0 to BRIGHTNESS_7.
 * \param[in]
 *    SetData - First address for display data
 * \param[in]
 *    SetAddr - First address for display
 * \par Output
 *    Cmd_SetData - Private variable Cmd_SetData of class DigitalDisplay.
 *    Cmd_SetAddr - Private variable Cmd_SetAddr of class DigitalDisplay.
 ...
 *    None
 */
void DigitalDisplay::set(uint8_t brightness, uint8_t SetData, uint8_t SetAddr)
{
  Cmd_SetData = SetData;
  Cmd_SetAddr = SetAddr;
 ...
 *    None
 */
void DigitalDisplay::setBrightness(uint8_t brightness)
{
 ...
 *    None
 */
void DigitalDisplay::coding(uint8_t DispData[])
{
 ...
 *    None
 */
uint8_t DigitalDisplay::coding(uint8_t DispData)
{
